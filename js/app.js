// Family Day — Bestelkaart (M3 Lavender)
const MENU = {
    lunch: {
        adult: [
        ...
        <div class="card order-card px-5 py-4 fade-in" onclick="editOrder(${idx})">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-1 shrink-0">
                    ...
                    <button onclick="event.stopPropagation();deleteOrder(${idx})" class="p-3 -mr-3 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center" style="color:#A98ADB">
